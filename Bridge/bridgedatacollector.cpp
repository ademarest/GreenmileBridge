...
void BridgeDataCollector::handleAS400LocationQuery(const QMap<QString, QVariantList> &sql)
{
    ...
    QString creationQuery = "CREATE TABLE `as400LocationQuery` "
                            ...
                            "`location:addressLine2` TEXT, "
                            "`location:city` TEXT, "
                            "`location:mondayRoute` TEXT, "
                            "`location:tuesdayRoute` TEXT, "
                            "`location:wednesdayRoute` TEXT, "
                            "`location:thursdayRoute` TEXT, "
                            "`location:fridayRoute` TEXT, "
                            "`location:saturdayRoute` TEXT, "
                            "`location:sundayRoute` TEXT, "
                            "`location:deliveryDays` TEXT, "
                            "`location:description` TEXT, "
                            "`location:state` TEXT, "
                            "`location:zipCode` TEXT, "
